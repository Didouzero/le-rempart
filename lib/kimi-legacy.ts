...
/**
 * Ancien chemin monolithique (recherche + rédaction dans un seul appel).
 * Conservé pour l'étape A / fallback ; ne plus appeler directement hors pipeline.
 */
export async function generateArticleLegacy(input: {
  title: string;
  sourceText?: string;
  sourceUrl?: string;
