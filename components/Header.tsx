      ...
      {!compact && (
        <div>
            ...
            <div className="absolute right-2 top-2 z-10 flex w-[min(100%,11.5rem)] origin-top-right scale-[0.78] flex-col items-stretch gap-1.5 sm:right-6 sm:top-6 sm:w-[13.5rem] sm:scale-100">
              <Link
                href="/s-abonner"
                className="group inline-flex w-full items-center gap-2 rounded-lg border border-accent/50 bg-accent px-3 py-2 text-ink no-underline shadow-[0_8px_24px_rgba(255,189,89,0.35)] transition duration-300 hover:-translate-y-0.5 hover:border-accent hover:bg-accent-deep hover:no-underline hover:shadow-[0_12px_28px_rgba(255,189,89,0.45)] sm:gap-3 sm:px-4 sm:py-2.5"
              >
                <CrownCircleIcon className="h-7 w-7 sm:h-8 sm:w-8" />
              ...
              {isPlus ? null : (
                <Link
                  href="/connexion"
                  className="group inline-flex w-full items-center gap-2 rounded-lg border border-accent/50 bg-ink px-3 py-2 text-accent no-underline shadow-[0_8px_24px_rgba(0,0,0,0.28)] transition duration-300 hover:-translate-y-0.5 hover:border-accent hover:bg-accent hover:text-ink hover:no-underline sm:gap-3 sm:px-4 sm:py-2.5"
                >
