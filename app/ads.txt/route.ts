/**
 * ads.txt — AdSense Le Rempart + vendeurs MGID (liste dashboard).
 * Ne pas fusionner MGID_ADS_TXT : une 2e ligne MediaGrid (autre TAG-ID)
 * fait croire à MGID que 9fac4a4a87c2a44f manque encore.
 */
const ADS_TXT = `\
